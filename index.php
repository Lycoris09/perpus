...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.php"><img src="assets/img/logo_buku2-removebg-preview.png" alt="Logo" width="30" height="30" class="d-inline-block align-text-top">Perpustakaan</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        ?>
                        <li><a class="dropdown-item" href="register-admin.php">Register</a></li>
                        <?php
                            }
                        ?>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="?page=peminjaman/histori_peminjaman">
                                <div class="sb-nav-link-icon"><i class="fas fa-book-open"></i></div>
                                Histori Peminjaman
                            </a>
                            <?php
                                ...
                                if($_SESSION['user']['level']!='anggota'){
                            ?>
                                <a class="nav-link" href="?page=peminjaman/laporan_peminjaman">
                                <div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
                                Laporan Peminjam</a>
                                <?php
                                }
