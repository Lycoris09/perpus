                                    ...
                                    <div class="card-body">
                                        <?php
                                         if(isset($_POST['register'])){
                                            ...
                                            $tambah = mysqli_query($koneksi, "INSERT INTO `t_user`(username,password,email,telp,nama_lengkap,alamat,level) VALUES ('$username','$password','$email','$telp','$nama','$alamat','anggota')");

                                            if($tambah){
                                                echo'<script>alert("selamat anda telah berhasil membuat akun"); location.href="login.php"</script>';
                                            }
                                            else{
